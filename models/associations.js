...
//       // ==================== СВЯЗИ ДЛЯ FRIEND ====================
//       // Добавьте после связей для ConnectionRequest или в любой подходящий раздел

//       // Проверяем, что модель Friend существует
//       if (db.friend) {
//          const Friend = db.friend;

//          // Связь с инициатором (пользователь, который отправил запрос)
//          Friend.belongsTo(User, {
//             foreignKey: 'user_id',
//             as: 'initiator'
//          });

//          // Связь с получателем (пользователь, который получает запрос)
//          Friend.belongsTo(User, {
...
//          console.log('✓ Ассоциации для Friend установлены');
//       } else {
//          console.warn('⚠ Модель Friend не найдена в db');
//       }
